...
import org.apache.curator.x.discovery.event.EventTypes;
...
public class ServiceDiscoveryImpl<T> implements ServiceDiscovery<T> {
    ...
    private final ConcurrentMap<String, PathChildrenCache> subListenerEventMap = Maps.newConcurrentMap();
    ...
    public ServiceDiscoveryImpl(CuratorFramework client, String basePath,
                                ...
                                ServiceInstance<T> thisInstance,
                                boolean watchInstances) {
        this(client, basePath, serializer, thisInstance, watchInstances, null);
    }
            ...
            public void childEvent(CuratorFramework client, PathChildrenCacheEvent event) throws Exception {
                if (event.getType() == PathChildrenCacheEvent.Type.CHILD_REMOVED
                    ...
                    if (event.getType() == PathChildrenCacheEvent.Type.CHILD_ADDED ||
                        ...
                        //delete
                        PathChildrenCache rmCache = subListenerEventMap.remove(subPath);
                        if (rmCache != null) {
                            rmCache.close();
                        }
                    }
            ...
            public void childEvent(CuratorFramework client, PathChildrenCacheEvent event) throws Exception {
                if (event.getType() == PathChildrenCacheEvent.Type.CHILD_REMOVED
                    ...
                    if (event.getType() == PathChildrenCacheEvent.Type.CHILD_ADDED ||
                        ...
                        //delete
                        if (callBackEvent != null) {
                            callBackEvent.onEvent(EventTypes.DELETE, instance);
                        }
                    }
                }
            }
